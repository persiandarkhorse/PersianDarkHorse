...
export default function Home() {
  ...
  const [imageGenerationSettings, setImageGenerationSettings] = useState({ ratio: "1:1", quality: "High", duration: "10 ثانیه", size: "1024×1024" });
  ...
  function applyCreationSettings() {
    ...
    const config = configs[creationSettings.toolId] ?? "تنظیمات پیش‌فرض FEZI";
    if (creationSettings.toolId === "image") {
      setImageGenerationSettings({ ratio: creationRatio, quality: creationQuality, duration: creationDuration, size: creationSize });
